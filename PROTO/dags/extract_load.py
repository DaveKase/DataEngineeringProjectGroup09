...
def load_production_to_duckdb(**kwargs):
    ...
    PARQUET_BASE_DIR = '/mnt/tmp/warehouse/production/'  # Base directory for Parquet files
...
def load_price_to_duckdb(**kwargs):
    ...
    PARQUET_BASE_DIR = '/mnt/tmp/warehouse/price/'  # Base directory for Parquet files
...
with DAG(
    ...
    load_production_to_duckdb = PythonOperator(
        task_id='load_production_to_duckdb',
        python_callable=load_production_to_duckdb
    )
    load_price_to_duckdb = PythonOperator(
        task_id='load_price_to_duckdb',
        python_callable=load_price_to_duckdb
    )
    load_consumption_to_duckdb = PythonOperator(
        task_id='load_consumption_to_duckdb',
        python_callable=load_consumption_to_duckdb
    )
    load_weather_to_duckdb = PythonOperator(
